...
M.highlights.cmp_item_abbr_match = Highlight.new("CmpItemAbbrMatch", { fg = c.niagara })
M.highlights.cmp_item_abbr_match_fuzzy = Highlight.new("CmpItemAbbrMatchFuzzy", { fg = c["fg-1"] })
