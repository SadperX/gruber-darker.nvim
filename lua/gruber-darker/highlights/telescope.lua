...
M.highlights.telescope_title = Highlight.new("TelescopeTitle", { fg = c.quartz })
M.highlights.telescope_selection = Highlight.new("TelescopeSelection", { fg = c.brown, bg = c['bg+1'] })
